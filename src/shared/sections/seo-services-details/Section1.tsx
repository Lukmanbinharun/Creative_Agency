        ...
        <div className="row g-4 align-items-end">
          ...
          <div className="col-lg-5 ms-auto">
            <h6 className="fw-600 reveal-text mb-0">
              <RevealText>
                We improve visibility with technical, on-page, and content SEO
                that helps your business show up for the right searches and grow
                over time.
              </RevealText>
            </h6>
          </div>
