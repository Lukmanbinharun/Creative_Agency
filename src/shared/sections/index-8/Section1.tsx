        ...
        <div className="row g-0 h8-row-1 align-items-start">
          ...
          <div className="col-xl-6 h8-col-left">
            <div className="d-flex align-items-start h8-headline-group">
              ...
              <Link
                to="/contact-1"
                className="h8-badge flex-shrink-0 at_fade_anim"
                data-start="100%"
                data-delay=".1"
                aria-label="Let's Talk"
              >
                <svg
                  className="h8-badge__bg"
                  viewBox="0 0 141 141"
                  fill="none"
          ...
          <div className="col-xl-6 h8-col-right">
            <div className="h8-photos d-flex align-items-start">
              <div
                className="h8-photo-box anim-zoomin-wrap"
                scroll-parallax-range="228"
                data-h8-parallax-ease="sine.inOut"
              >
                <img
                  className="anim-zoomin"
                  src="/assets/imgs/pages/home-8/hero8-img-1.webp"
                  alt="orisa"
                  width={500}
                  height={600}
                  loading="lazy"
              ...
              <div
                className="h8-photo-box h8-photo-down anim-zoomin-wrap"
                scroll-parallax-range="110"
                data-h8-parallax-ease="power3.in"
              >
                <img
                  className="anim-zoomin"
                  src="/assets/imgs/pages/home-8/hero8-img-2.webp"
                  alt="orisa"
                  width={500}
                  height={600}
                  loading="lazy"
              ...
              <div
                className="h8-photo-box anim-zoomin-wrap"
                scroll-parallax-range="52"
                data-h8-parallax-ease="sine.inOut"
              >
                <img
                  className="anim-zoomin"
                  src="/assets/imgs/pages/home-8/hero8-img-3.webp"
                  alt="orisa"
                  width={500}
                  height={600}
                  loading="lazy"
        ...
        <div className="row g-0 h8-row-2 align-items-start">
          ...
          <div className="col-xl-6 h8-col-left-2 d-none d-xl-block">
            <div className="h8-photos d-flex align-items-start">
              <div
                className="h8-photo-box h8-photo-down anim-zoomin-wrap"
                scroll-parallax-range="92"
                data-h8-parallax-ease="expo.in"
              >
                <img
                  className="anim-zoomin"
                  src="/assets/imgs/pages/home-8/hero8-img-4.webp"
                  alt="orisa"
                  width={500}
                  height={600}
                  loading="lazy"
              ...
              <div
                className="h8-photo-box anim-zoomin-wrap"
                scroll-parallax-range="24"
                data-h8-parallax-ease="none"
              >
                <img
                  className="anim-zoomin"
                  src="/assets/imgs/pages/home-8/hero8-img-5.webp"
                  alt="orisa"
                  width={500}
                  height={600}
                  loading="lazy"
              ...
              <div
                className="h8-photo-box h8-photo-down anim-zoomin-wrap"
                scroll-parallax-range="125"
                data-h8-parallax-ease="power2.inOut"
              >
                <img
                  className="anim-zoomin"
                  src="/assets/imgs/pages/home-8/hero8-img-6.webp"
                  alt="orisa"
                  width={500}
                  height={600}
                  loading="lazy"
          ...
          <div className="col-xl-6 h8-col-right-2">
            <div className="h8-stats d-flex">
              <div
                className="h8-stat at_fade_anim"
                data-start="100%"
                data-delay=".2"
                data-fade-from="bottom"
              >
                <p className="h8-stat-num">
                  <OdometerCounter count={35} />%
                </p>
                <p className="h8-stat-desc reveal-text">
                  <RevealText>
                    Average increase in conversion rate for our partners.
                  </RevealText>
                </p>
              </div>
              <div
              ...
              >
                <p className="h8-stat-num">
                  <OdometerCounter count={24} />
                  k+
                </p>
                <p className="h8-stat-desc reveal-text">
                  <RevealText>
                    Users interacting with our interfaces daily worldwide.
                  </RevealText>
                </p>
              </div>
            </div>
      ...
      <div className="h8-bottom-band">
        <p className="h8-big-title">
          ...
          {/* <span className="h8-portrait-frame">
            <img
              src="/assets/imgs/pages/home-8/hero8-img-8.gif"
              alt="orisa"
              width={120}
              height={120}
              loading="lazy"
        ...
        <div className="h8-bottom-meta d-flex align-items-center justify-content-between">
          <span
            className="h8-meta-text text-scramble"
            data-scramble-text="hello@orisa.com"
          >
            hello@orisa.com
          </span>
          <div className="d-flex align-items-center gap-2">
            ...
            <span
              className="h8-meta-text text-scramble"
              data-scramble-text="27.1127° S, 109.3497° W"
            >
