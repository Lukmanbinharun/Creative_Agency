...
const RECEIVE_ITEMS = [
  ...
  "A fast and responsive build",
  "A launch-ready digital product",
];
          ...
          <div className="row g-4 align-items-center">
            <div className="col-lg-6">
              <div className="rounded-5 border border-neutral-200 bg-neutral-50 p-4 p-md-5">
                <h4 className="fw-600 mb-3">What you can expect</h4>
                <p className="mb-0 neutral-950">
                  A thoughtful web experience that balances visual quality,
                  technical performance, and business goals from the first
            ...
            <div className="col-lg-5 mx-auto">
              ...
              <h4 className="reveal-text mb-0 fw-600 pe-lg-5">
                <RevealText>
                  Together, we create digital experiences that feel premium,
                  perform well, and support your growth.
                </RevealText>
              </h4>
              ...
              <div className="testimonial-author d-flex align-items-start mb-0 gap-4">
                ...
                <div className="testimonial-content">
                  <p className="fz-xl neutral-900 fw-400">
                    &quot;Orisa completely transformed how we present our brand
                    online. Their strategic mindset and attention to detail
                    resulted in a digital experience that feels both refined and
                    high-performing.&quot;
                  </p>
