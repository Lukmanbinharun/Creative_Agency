...
const STEPS = [
  {
    ...
    title: "Discover",
    description:
      "We define your goals, audience, and the experience you want to create.",
    img: "/assets/imgs/pages/img-161.webp",
    cardClass:
      "at-service-card hover-up card-1 no-before rounded-2 overflow-hidden p-relative bg-neutral-0 z-index-3",
  },
  {
    num: "02",
    title: "Design",
    description:
      "We shape the visual direction, structure, and interaction flow.",
    img: "/assets/imgs/pages/img-162.webp",
    cardClass:
      "at-service-card hover-up card-2 rounded-2 overflow-hidden p-relative bg-neutral-0",
  },
  {
    num: "03",
    title: "Build",
    description:
      "We turn the experience into a fast, reliable website or web app.",
    img: "/assets/imgs/pages/img-163.webp",
    cardClass:
      "at-service-card hover-up card-3 rounded-2 overflow-hidden p-relative bg-neutral-0",
  },
  {
    num: "04",
    title: "Launch",
    description:
      "We refine, optimize, and support your launch for long-term growth.",
        ...
        <div className="row g-4">
          <div className="col-lg-6">
            ...
            <h3 className="reveal-text mb-20">
              <RevealText>How we approach web projects</RevealText>
            </h3>
            <h6 className="fw-500 mb-0">
              We combine clear strategy, refined design, and strong development
              into a simple process that keeps your project moving forward.
            </h6>
          </div>
