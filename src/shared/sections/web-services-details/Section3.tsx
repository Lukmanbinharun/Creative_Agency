...
const ICON_2 = (
  ...
  >
    <path
      d="M48 7.2C48 11.1764 44.7764 14.4 40.8 14.4C36.8235 14.4 33.6 11.1764 33.6 7.2C33.6 3.22355 36.8235 0 40.8 0C44.7764 0 48 3.22355 48 7.2Z"
      fill="currentColor"
    />
    <path
      d="M48 40.8C48 44.7764 44.7764 48 40.8 48C36.8235 48 33.6 44.7764 33.6 40.8C33.6 36.8235 36.8235 33.6 40.8 33.6C44.7764 33.6 48 36.8235 48 40.8Z"
      fill="currentColor"
    />
    <path
      d="M36.24 24C36.24 30.76 30.76 36.24 24 36.24C17.24 36.24 11.76 30.76 11.76 24C11.76 17.24 17.24 11.76 24 11.76C30.76 11.76 36.24 17.24 36.24 24Z"
      fill="currentColor"
    />
    <path
      d="M14.4 7.2C14.4 11.1764 11.1764 14.4 7.2 14.4C3.22355 14.4 0 11.1764 0 7.2C0 3.22355 3.22355 0 7.2 0C11.1764 0 14.4 3.22355 14.4 7.2Z"
      fill="currentColor"
    />
    <path
      d="M14.4 40.8C14.4 44.7764 11.1764 48 7.2 48C3.22355 48 0 44.7764 0 40.8C0 36.8235 3.22355 33.6 7.2 33.6C11.1764 33.6 14.4 36.8235 14.4 40.8Z"
      fill="currentColor"
    />
  </svg>
);
...
const ITEMS = [
  {
    ...
    description:
      "We create clear, elegant interfaces that feel intuitive and guide users naturally through the journey.",
  },
  {
    icon: ICON_2,
    title: "Responsive Development",
    description:
      "Every website is built to look refined and perform smoothly across desktop, tablet, and mobile.",
  },
  {
    icon: ICON_3,
    title: "Modern Tech Stack",
    description:
      "We work with React, Next.js, Vue, Webflow, and Shopify to build scalable digital experiences.",
  },
  {
    icon: ICON_4,
    title: "Performance & SEO",
    description:
      "We optimize speed, structure, and content so your site not only looks great but also ranks and converts better.",
  },
];
        ...
        <div className="row">
          <div className="col-lg-5 h-100">
            ...
            <h3 className="reveal-text mb-40">
              <RevealText>
                Great web experiences are built on thoughtful design and solid
                development.
              </RevealText>
            </h3>
            <h6 className="fw-600 mb-0">
              We combine strategy, UX, and technical execution to build digital
              products that are attractive, fast, and easy to use.
            </h6>
