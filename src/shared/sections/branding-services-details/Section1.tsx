        ...
        <div className="row g-4 align-items-end">
          <div className="col-lg-5 pt-lg-0 pt-100">
            <div className="d-flex align-items-center gap-2 mb-2">
              ...
              <span className="text-uppercase neutral-900 fw-600">
                ...
                <span className="text-1 neutral-500"> branding</span>
              </span>
            </div>
            <h1 className="section-title d-flex fw-600 reveal-text mb-40 text-nowrap">
              <RevealText>Branding</RevealText>
            </h1>
          ...
          <div className="col-lg-5 ms-auto">
            <h6 className="fw-600 reveal-text mb-0">
              <RevealText>
                We shape bold identities that help your business feel clear,
                memorable, and ready to grow.
              </RevealText>
            </h6>
          </div>
        </div>
