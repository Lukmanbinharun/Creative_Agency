...
const ITEMS = [
  {
    ...
    description: "We define how the brand should feel, speak, and stand apart.",
  },
  {
    title: "Visual identity",
    description: "We design the logo, palette, typography, and imagery system.",
  },
  {
    title: "Messaging system",
    description: "We shape the voice and copy framework for all touchpoints.",
  },
];
        ...
        <div className="row">
          <div className="col-lg-5">
            ...
            <h3 className="reveal-text mb-40">
              <RevealText>
                Identity systems that feel premium and consistent.
              </RevealText>
            </h3>
            <h6 className="fw-600 mb-0">
              We connect strategy, visuals, and voice into a brand experience
